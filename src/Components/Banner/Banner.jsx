        ...
        <div>
            ...
            {/* it is the text and button section  */}
                <div className='flex flex-col w-fit h-fit text-ce space-y-2.5'>
                    <div className=' '>
                        <div className='flex w-fit py-1 px-2.5 rounded-2xl bg-[#5d66e63b] gap-1.5'>
                    ...
                    <h1 className='text-5xl font-bold'>Supercharge Your<br /><span className='bg-gradient-to-r from-[#4f39f6] to-[#9514fa] bg-clip-text text-transparent'>Digital Workflow</span> </h1>
