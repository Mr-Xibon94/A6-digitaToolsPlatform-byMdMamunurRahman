    ...
    return (
        <div>
            <div className='bg-black p-5 mt-10'>
                <div className='flex flex-col justify-center md:flex-row w-11/12 mx-auto gap-2.5 py-15'>
                    <div className='flex flex-col text-white text-center flex-1 gap-5 px-10 mr-10'>
                    ...
                    <div className='text-white flex-1 flex flex-col gap-2.5 text-center'>
                    ...
                    <div className='text-white flex-1 flex flex-col gap-2.5 text-center '>
                        <h1>Resources</h1>
                        <ul className='text-white opacity-70 flex flex-col gap-2.5 text-center'>
                            <li>Documnetation</li>
                            <li>Help Center</li>
                            <li>Community</li>
                            <li>Contact</li>
